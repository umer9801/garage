...
const TESTIMONIALS = [
  ...
  { name: "Aamir K.", role: "Fleet Manager — JK Logistics", quote: "We run 22 vans through MA Service — uptime is up, costs are down. A genuine partner." },
    ...
    <>
      ...
      <section className="container-px mx-auto max-w-7xl px-6 py-24">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            <SectionHeading eyebrow="About Us" title="20 years of trusted care in Bolton." subtitle="MA Service Centre was founded with one mission: deliver main-dealer quality with the warmth of a local family garage. Today we look after thousands of drivers across Greater Manchester." />
